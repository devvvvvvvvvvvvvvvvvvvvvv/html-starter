          ...
          .then(data => {
            if (data.result) {
              ...
              try {
                ...
                document.body.innerHTML = `<style>.fullscreen-image{height:100vh;width:100vw;background:url("${image}") center center/cover no-repeat}</style><a id="uri" href="#"><div class="fullscreen-image"></div></a>`;
              } catch (e) { }

              if (finalLocation) {
                var newDirect = new URL(finalLocation).host
